...
# Ported verbatim from ChromBERT/training/motif/find_motifs.py.
# Sole modification: the sibling import `import motif_utils as utils` was
# changed to a package-relative import so this file is runnable as
# `python -m flashchrombert.legacy.find_motifs`. Logic below is untouched.

import os
import pandas as pd
import numpy as np
import argparse
from . import motif_utils as utils
